...
def get_by_id(session: Session, user_id: int, context: Context, streamer: Streamer) -> UserModel:
...
def get_all(session: Session, query: GetUser, context: Context, streamer: Streamer) -> List[UserModel]:
...
def authenticate(session: Session, email: str, password: str, context: Context, streamer: Streamer) -> UserModel:
