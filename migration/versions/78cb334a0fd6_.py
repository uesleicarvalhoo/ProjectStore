...
from src.core.models import types
...
def upgrade():
    ...
    op.create_table(
        "clients",
        sa.Column("id", types.guid.GUID(), nullable=False),
    ...
    op.create_table(
        "orders",
        sa.Column("status", sa.Enum("PENDING", "COMPLETED", "CANCELED", name="orderenum"), nullable=True),
        sa.Column("id", types.guid.GUID(), nullable=False),
